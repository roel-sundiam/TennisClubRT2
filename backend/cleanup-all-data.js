...
async function cleanupAllData() {
  try {
    ...
    const totalRecords = paymentCount + reservationCount + pollCount + coinTransactionCount;
    ...
    // 5. Reset user stats but keep accounts
...
console.log('⚠️  WARNING: This will permanently delete ALL payments, reservations, open play events, and reset user stats!');
