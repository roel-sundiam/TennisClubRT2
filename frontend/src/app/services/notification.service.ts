    ...
    payments.forEach(payment => {
      ...
      if (daysDiff < 0) {
        ...
        notification = {
          ...
          message: `Payment of ${payment.formattedAmount} is ${daysOverdue} day${daysOverdue !== 1 ? 's' : ''} overdue`,
        ...
        notification = {
          ...
          message: `Payment of ${payment.formattedAmount} is due today`,
          amount: payment.amount,
          dueDate: new Date(payment.dueDate),
          daysOverdue: 0,
          reservationId: payment.reservationId?._id || '',
        ...
        notification = {
          ...
          message: `Payment of ${payment.formattedAmount} is due in ${daysDiff} day${daysDiff !== 1 ? 's' : ''}`,
          amount: payment.amount,
          dueDate: new Date(payment.dueDate),
          daysOverdue: 0,
          reservationId: payment.reservationId?._id || '',
